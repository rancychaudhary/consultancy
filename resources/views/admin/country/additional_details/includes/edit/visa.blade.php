    ...
    <div class="row">
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="visa_subtitle" name="visa_subtitle"
                placeholder="Visa Application Subtitle" value="{{ old('visa_subtitle', $country->visa_subtitle) }}" />
            @error('visa_subtitle')
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control ckeditor3" id="visa_description" name="visa_description"
                placeholder="Visa Application Description" rows="10">{{ old('visa_description', $country->visa_description) }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input class="form-control dropify" type="file" id="visa_image" name="visa_image"
                value="{{ old('visa_image', $country->visa_image) }}"
                data-default-file="{{ asset($country->visa_image) }}" />
