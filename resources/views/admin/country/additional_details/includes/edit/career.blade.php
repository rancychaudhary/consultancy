    ...
    <div class="row">
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="career_subtitle" name="career_subtitle"
                ...
                value="{{ old('career_subtitle', $country->career_subtitle) }}" />
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control ckeditor1" id="career_description" name="career_description"
                placeholder="Career Counseling Description" rows="10">{{ old('career_description', $country->career_description) }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input class="form-control dropify" type="file" id="career_image" name="career_image"
                value="{{ old('career_image', $country->career_image) }}"
                data-default-file="{{ asset($country->career_image) }}" />
