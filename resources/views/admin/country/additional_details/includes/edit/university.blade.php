    ...
    <div class="row">
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="university_subtitle" name="university_subtitle"
                ...
                value="{{ old('university_subtitle', $country->university_subtitle) }}" />
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control ckeditor2" id="university_description" name="university_description"
                placeholder="University Selection Description" rows="10">{{ old('university_description', $country->university_description) }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input class="form-control dropify" type="file" id="university_image" name="university_image"
                value="{{ old('university_image', $country->university_image) }}"
                data-default-file="{{ asset($country->university_image) }}" />
