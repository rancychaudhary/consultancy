...
<head>
    ...
    {{-- <link rel="icon" type="image/jpg"
        href="{{ $settings['site_fav_icon'] ? asset($settings['site_fav_icon']) : asset('frontend/images/candid-logo.jpg') }}" rel="shortcut icon" /> --}}
    {{-- <link rel="icon" type="image/jpg" href="{{ asset('frontend/images/bg.png') }}"> --}}
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item open" style="">
                        <a href="" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons ri-customer-service-2-fill"></i>
                            <div class="text-truncate" data-i18n="Layouts">Inquries</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="layouts-without-menu.html" class="menu-link">
                                    <div class="text-truncate" data-i18n="Without menu">Contact Inquries</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    {{-- <li>
                                        <a class="dropdown-item" href="">
                                            <i class="bx bx-user me-2 ri-user-line"></i>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by Paradise info tech
                            </div>
